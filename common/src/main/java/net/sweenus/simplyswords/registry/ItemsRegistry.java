...
public class ItemsRegistry {
            ...
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + longsword_positive_modifier - longsword_negative_modifier), longsword_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_TWINBLADE = ITEM.register("iron_twinblade", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + twinblade_positive_modifier - twinblade_negative_modifier), twinblade_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_RAPIER = ITEM.register("iron_rapier", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + rapier_positive_modifier - rapier_negative_modifier), rapier_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_KATANA = ITEM.register("iron_katana", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + katana_positive_modifier - katana_negative_modifier), katana_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_SAI = ITEM.register("iron_sai", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + sai_positive_modifier - sai_negative_modifier), sai_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_SPEAR = ITEM.register("iron_spear", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + spear_positive_modifier - spear_negative_modifier), spear_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_GLAIVE = ITEM.register("iron_glaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + glaive_positive_modifier - glaive_negative_modifier), glaive_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_WARGLAIVE = ITEM.register("iron_warglaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + warglaive_positive_modifier - warglaive_negative_modifier), warglaive_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_CUTLASS = ITEM.register("iron_cutlass", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + cutlass_positive_modifier - cutlass_negative_modifier), cutlass_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_CLAYMORE = ITEM.register("iron_claymore", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + claymore_positive_modifier - claymore_negative_modifier), claymore_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_GREATHAMMER = ITEM.register("iron_greathammer", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + greathammer_positive_modifier - greathammer_negative_modifier), greathammer_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_GREATAXE = ITEM.register("iron_greataxe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + greataxe_positive_modifier - greataxe_negative_modifier), greataxe_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_CHAKRAM = ITEM.register("iron_chakram", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + chakram_positive_modifier - chakram_negative_modifier), chakram_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_SCYTHE = ITEM.register("iron_scythe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + scythe_positive_modifier - scythe_negative_modifier), scythe_attackspeed)), "minecraft:iron_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> IRON_HALBERD = ITEM.register("iron_halberd", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.COMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON,
                                    (int) (iron_modifier + halberd_positive_modifier - halberd_negative_modifier), halberd_attackspeed)), "minecraft:iron_ingot"));
            ...
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + longsword_positive_modifier - longsword_negative_modifier), longsword_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_TWINBLADE = ITEM.register("gold_twinblade", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + twinblade_positive_modifier - twinblade_negative_modifier), twinblade_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_RAPIER = ITEM.register("gold_rapier", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + rapier_positive_modifier - rapier_negative_modifier), rapier_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_KATANA = ITEM.register("gold_katana", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + katana_positive_modifier - katana_negative_modifier), katana_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_SAI = ITEM.register("gold_sai", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + sai_positive_modifier - sai_negative_modifier), sai_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_SPEAR = ITEM.register("gold_spear", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + spear_positive_modifier - spear_negative_modifier), spear_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_GLAIVE = ITEM.register("gold_glaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + glaive_positive_modifier - glaive_negative_modifier), glaive_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_WARGLAIVE = ITEM.register("gold_warglaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + warglaive_positive_modifier - warglaive_negative_modifier), warglaive_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_CUTLASS = ITEM.register("gold_cutlass", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + cutlass_positive_modifier - cutlass_negative_modifier), cutlass_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_CLAYMORE = ITEM.register("gold_claymore", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + claymore_positive_modifier - claymore_negative_modifier), claymore_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_GREATHAMMER = ITEM.register("gold_greathammer", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + greathammer_positive_modifier - greathammer_negative_modifier), greathammer_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_GREATAXE = ITEM.register("gold_greataxe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + greataxe_positive_modifier - greataxe_negative_modifier), greataxe_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_CHAKRAM = ITEM.register("gold_chakram", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + chakram_positive_modifier - chakram_negative_modifier), chakram_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_SCYTHE = ITEM.register("gold_scythe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + scythe_positive_modifier - scythe_negative_modifier), scythe_attackspeed)), "minecraft:gold_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> GOLD_HALBERD = ITEM.register("gold_halberd", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.UNCOMMON)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.GOLD,
                                    (int) (gold_modifier + halberd_positive_modifier - halberd_negative_modifier), halberd_attackspeed)), "minecraft:gold_ingot"));
            ...
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + longsword_positive_modifier - longsword_negative_modifier), longsword_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_TWINBLADE = ITEM.register("diamond_twinblade", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                            (int) (diamond_modifier + twinblade_positive_modifier - twinblade_negative_modifier), twinblade_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_RAPIER = ITEM.register("diamond_rapier", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + rapier_positive_modifier - rapier_negative_modifier), rapier_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_KATANA = ITEM.register("diamond_katana", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + katana_positive_modifier - katana_negative_modifier), katana_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_SAI = ITEM.register("diamond_sai", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + sai_positive_modifier - sai_negative_modifier), sai_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_SPEAR = ITEM.register("diamond_spear", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + spear_positive_modifier - spear_negative_modifier), spear_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_GLAIVE = ITEM.register("diamond_glaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + glaive_positive_modifier - glaive_negative_modifier), glaive_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_WARGLAIVE = ITEM.register("diamond_warglaive", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + warglaive_positive_modifier - warglaive_negative_modifier), warglaive_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_CUTLASS = ITEM.register("diamond_cutlass", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + cutlass_positive_modifier - cutlass_negative_modifier), cutlass_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_CLAYMORE = ITEM.register("diamond_claymore", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + claymore_positive_modifier - claymore_negative_modifier), claymore_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_GREATHAMMER = ITEM.register("diamond_greathammer", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + greathammer_positive_modifier - greathammer_negative_modifier), greathammer_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_GREATAXE = ITEM.register("diamond_greataxe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + greataxe_positive_modifier - greataxe_negative_modifier), greataxe_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_CHAKRAM = ITEM.register("diamond_chakram", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + chakram_positive_modifier - chakram_negative_modifier), chakram_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_SCYTHE = ITEM.register("diamond_scythe", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + scythe_positive_modifier - scythe_negative_modifier), scythe_attackspeed)), "minecraft:diamond"));
    ...
    public static final RegistrySupplier<SimplySwordsSwordItem> DIAMOND_HALBERD = ITEM.register("diamond_halberd", () ->
            new SimplySwordsSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND,
                                    (int) (diamond_modifier + halberd_positive_modifier - halberd_negative_modifier), halberd_attackspeed)), "minecraft:diamond"));
            ...
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + longsword_positive_modifier - longsword_negative_modifier), longsword_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_TWINBLADE = ITEM.register("netherite_twinblade", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + twinblade_positive_modifier - twinblade_negative_modifier), twinblade_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_RAPIER = ITEM.register("netherite_rapier", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + rapier_positive_modifier - rapier_negative_modifier), rapier_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_KATANA = ITEM.register("netherite_katana", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + katana_positive_modifier - katana_negative_modifier), katana_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_SAI = ITEM.register("netherite_sai", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + sai_positive_modifier - sai_negative_modifier), sai_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_SPEAR = ITEM.register("netherite_spear", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + spear_positive_modifier - spear_negative_modifier), spear_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_GLAIVE = ITEM.register("netherite_glaive", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + glaive_positive_modifier - glaive_negative_modifier), glaive_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_WARGLAIVE = ITEM.register("netherite_warglaive", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + warglaive_positive_modifier - warglaive_negative_modifier), warglaive_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_CUTLASS = ITEM.register("netherite_cutlass", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + cutlass_positive_modifier - cutlass_negative_modifier), cutlass_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_CLAYMORE = ITEM.register("netherite_claymore", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + claymore_positive_modifier - claymore_negative_modifier), claymore_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_GREATHAMMER = ITEM.register("netherite_greathammer", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + greathammer_positive_modifier - greathammer_negative_modifier), greathammer_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_GREATAXE = ITEM.register("netherite_greataxe", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + greataxe_positive_modifier - greataxe_negative_modifier), greataxe_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_CHAKRAM = ITEM.register("netherite_chakram", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + chakram_positive_modifier - chakram_negative_modifier), chakram_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_SCYTHE = ITEM.register("netherite_scythe", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + scythe_positive_modifier - scythe_negative_modifier), scythe_attackspeed)), "minecraft:netherite_ingot"));
    ...
    public static final RegistrySupplier<SimplySwordsNetheriteSwordItem> NETHERITE_HALBERD = ITEM.register("netherite_halberd", () ->
            new SimplySwordsNetheriteSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.EPIC)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE,
                                    (int) (netherite_modifier + halberd_positive_modifier - halberd_negative_modifier), halberd_attackspeed)), "minecraft:netherite_ingot"));
            ...
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + longsword_positive_modifier - longsword_negative_modifier), longsword_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_TWINBLADE = ITEM.register("runic_twinblade", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + twinblade_positive_modifier - twinblade_negative_modifier), twinblade_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_RAPIER = ITEM.register("runic_rapier", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + rapier_positive_modifier - rapier_negative_modifier), rapier_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_KATANA = ITEM.register("runic_katana", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + katana_positive_modifier - katana_negative_modifier), katana_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_SAI = ITEM.register("runic_sai", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + sai_positive_modifier - sai_negative_modifier), sai_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_SPEAR = ITEM.register("runic_spear", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + spear_positive_modifier - spear_negative_modifier), spear_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_GLAIVE = ITEM.register("runic_glaive", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + glaive_positive_modifier - glaive_negative_modifier), glaive_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_WARGLAIVE = ITEM.register("runic_warglaive", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + warglaive_positive_modifier - warglaive_negative_modifier), warglaive_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_CUTLASS = ITEM.register("runic_cutlass", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + cutlass_positive_modifier - cutlass_negative_modifier), cutlass_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_CLAYMORE = ITEM.register("runic_claymore", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + claymore_positive_modifier - claymore_negative_modifier), claymore_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_CHAKRAM = ITEM.register("runic_chakram", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + chakram_positive_modifier - chakram_negative_modifier), chakram_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_GREATAXE = ITEM.register("runic_greataxe", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + greataxe_positive_modifier - greataxe_negative_modifier), greataxe_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_GREATHAMMER = ITEM.register("runic_greathammer", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + greathammer_positive_modifier - greathammer_negative_modifier), greathammer_attackspeed))));
    ...
    public static final RegistrySupplier<RunicSwordItem> RUNIC_SCYTHE = ITEM.register("runic_scythe", () ->
            new RunicSwordItem(
                    ...
                    new Item.Settings().arch$tab(SimplySwords.SIMPLYSWORDS).rarity(Rarity.RARE)
                            .attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterial.RUNIC,
                                    (int) (runic_modifier + scythe_positive_modifier - scythe_negative_modifier), scythe_attackspeed))));
